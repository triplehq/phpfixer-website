<?php include 'content/pages/_partials/header.php'; ?>
                ...
                <div class="w-full mt-12">
                    ...
                    <div class="font-light flex flex-col md:flex-row gap-4 md:gap-16 text-neutral-700">
                        <ul class="pl-0 space-y-1">
                            ...
                            <li><span class="text-purple-600 font-bold mr-2">✓</span>Laravel breaking after updates or upgrades</li>
                            <li><span class="text-purple-600 font-bold mr-2">✓</span>Deprecated PHP functions haunting your logs</li>
                            <li><span class="text-purple-600 font-bold mr-2">✓</span>Slow or crashing WordPress sites</li>
                            <li><span class="text-purple-600 font-bold mr-2">✓</span>Fatal errors from rogue plugins</li>
                            <li><span class="text-purple-600 font-bold mr-2">✓</span>500 Internal Server Errors with no clear cause</li>
                        </ul>
                        <ul class="pl-0 space-y-1">
                            <li><span class="text-purple-600 font-bold mr-2">✓</span>Memory leaks and performance bottlenecks</li>
                            <li><span class="text-purple-600 font-bold mr-2">✓</span>"No one knows how this works" codebases</li>
                            <li><span class="text-purple-600 font-bold mr-2">✓</span>Eliminating years of technical debt</li>
                            <li><span class="text-purple-600 font-bold mr-2">✓</span>Replacing abandoned packages</li>
                            <li><span class="text-purple-600 font-bold mr-2">✓</span>Switching hosting providers</li>
                            <li><span class="text-purple-600 font-bold mr-2">✓</span>Setting up regular, hands-off maintenance</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="hidden lg:flex w-full md:w-1/3 justify-center mt-8 md:mt-0">
                <img src="<?php echo asset('images/doctor-elephant.png'); ?>" alt="Elephant Doctor">
            </div>
        </div>
    </section>
    ...
    <section class="px-4 py-8">
        <div class="max-w-7xl mx-auto">
            <h3 class="text-4xl text-center font-semibold mb-6 leading-[1.20] bg-gradient-to-t from-neutral-800 to-neutral-600 bg-clip-text text-transparent">Fixing your code without burning everything down</h3>
            <p class="mb-8 text-lg font-light text-neutral-700 text-center">I diagnose the problem, isolate it, fix it and stabilise your code pushing for a costly rebuild you probably don't need.</p>
            <div class="flex flex-col lg:flex-row justify-between gap-6 lg:gap-8">
                <div class="flex-1 bg-neutral-100 rounded-xl p-6 md:p-8 flex flex-col md:flex-row items-center text-center md:text-left gap-3 md:gap-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <div class="text-sm/6 font-light text-neutral-700">I reproduce the issue and trace it through your codebase.</div>
                    </div>
                </div>
                <div class="flex-1 bg-neutral-100 rounded-xl p-6 md:p-8 flex flex-col md:flex-row items-center text-center md:text-left gap-3 md:gap-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <div class="text-sm/6 font-light text-neutral-700">I implement a focused solution, with rollback safety in place.</div>
                    </div>
                </div>
                <div class="flex-1 bg-neutral-100 rounded-xl p-6 md:p-8 flex flex-col md:flex-row items-center text-center md:text-left gap-3 md:gap-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <div class="text-sm/6 font-light text-neutral-700">I provide a short report by default or a full audit on request.</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="px-4 py-6">
        <div class="max-w-7xl mx-auto bg-gradient-to-r from-blue-900 via-indigo-900 to-purple-900 px-10 py-10 rounded-xl">
            <h3 class="text-4xl font-bold mb-6 leading-[1.20] bg-gradient-to-t from-neutral-300 to-white bg-clip-text text-transparent">Under the hood</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-base mb-2 text-neutral-100">
                <div class="bg-white/5 backdrop-blur-md border border-white/30 rounded-xl p-6 shadow-lg">
    ...
    <section class="py-12 px-4">
        <div class="max-w-7xl mx-auto">
            <h3 class="text-4xl text-center font-bold mb-8 leading-[1.20] bg-gradient-to-r from-purple-700 via-indigo-500 to-purple-400 bg-clip-text text-transparent">What clients say when their website finally works again</h3>
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                <div class="bg-neutral-100 rounded-xl p-6 shadow-sm relative after:content-[''] after:absolute after:bottom-[-20px] after:left-8 after:w-0 after:h-0 after:border-t-[20px] after:border-t-gray-100 after:border-l-[14px] after:border-l-transparent after:border-r-[14px] after:border-r-transparent after:border-b-0 after:border-b-transparent">
                    ...
                    <div class="font-bold text-xs text-gray-600">WordPress site owner (UK)</div>
                </div>
                <div class="bg-neutral-100 rounded-xl p-6 shadow-sm relative after:content-[''] after:absolute after:bottom-[-20px] after:left-8 after:w-0 after:h-0 after:border-t-[20px] after:border-t-gray-100 after:border-l-[14px] after:border-l-transparent after:border-r-[14px] after:border-r-transparent after:border-b-0 after:border-b-transparent">
                    ...
                    <div class="font-bold text-xs text-gray-600">Online Marketplace (EU)</div>
                </div>
                <div class="bg-neutral-100 rounded-xl p-6 shadow-sm relative after:content-[''] after:absolute after:bottom-[-20px] after:left-8 after:w-0 after:h-0 after:border-t-[20px] after:border-t-gray-100 after:border-l-[14px] after:border-l-transparent after:border-r-[14px] after:border-r-transparent after:border-b-0 after:border-b-transparent">
                    ...
                    <div class="font-bold text-xs text-gray-600">Lead Developer, SaaS Startup (UK)</div>
                </div>
            </div>
        </div>
    </section>
