<?php include 'content/pages/_partials/header.php'; ?>
    ...
    <section class="px-8 md:px-4 pb-8 py-10 relative">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
            <div class="w-full lg:w-2/3">
                <h2 class="text-4xl title md:text-6xl font-bold mb-4 leading-[1.20] text-stone-700">I fix broken websites and<span class="hidden md:inline"><br></span> fragile codebases</h2>
                <p class="text-base font-light md:text-lg/8 md:pr-10 mt-5 text-stone-700">Legacy codebase? Random crashes? Cursed pages? Upgrades gone wrong?<br class="hidden md:block"> I'm the handyman agencies and business owners keep on speed dial.</p>
    ...
    <section class="px-8 md:px-4 py-6">
        <div class="max-w-7xl mx-auto bg-gradient-to-b from-blue-600 via-sky-700 to-sky-700 p-5 md:p-10 rounded-xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 text-base mb-2 text-neutral-100">
                <div class="bg-white/15 border border-white/30 rounded-xl p-6 shadow-lg">
    ...
    <section class="px-8 md:px-4 py-12">
        <div class="max-w-7xl mx-auto">
            <h3 class="text-3xl md:text-4xl text-center font-bold mb-8 text-stone-700">What clients said about PHPFixer</h3>
            <div class="grid grid-cols-1 lg:grid-cols-3 md:space-y-6 gap-6 lg:gap-8">
                ...
                <div class="bg-neutral-100 text-base/6 text-stone-700 rounded-xl p-6 shadow-sm relative after:content-[''] after:absolute after:bottom-[-20px] after:left-8 after:w-0 after:h-0 after:border-t-[20px] after:border-t-gray-100 after:border-l-[14px] after:border-l-transparent after:border-r-[14px] after:border-r-transparent after:border-b-0 after:border-b-transparent">
                    <p class="mb-4 font-light">"We inherited a legacy Laravel project with no tests, inconsistent code, and fragile deployments. I convinced the management to give PHPFixer a go: he helped us to clean up the codebase, introduced basic testing and a proper deployment pipeline. That made a huge difference to our team's confidence and velocity."</p>
    ...
    <!-- CTA: Second Opinion -->
    <section class="px-8 md:px-4 py-16">
        <div class="max-w-7xl mx-auto flex flex-col gap-6 md:gap-0 md:flex-row justify-between items-center border border-stone-400/10 p-12 rounded-xl bg-gradient-to-t from-stone-100">
            <h3 class="text-2xl lg:text-4xl text-center md:text-left font-medium bg-gradient-to-t from-neutral-800 to-neutral-600 bg-clip-text text-transparent">Tired of firefighting? Let’s fix it for good.</h3>
            <div>
                <a href="#contact" class="inline-block px-6 py-3 md:text-lg font-semibold rounded-2xl bg-gradient-to-b from-cyan-500 to-blue-600 text-white rounded-xl shadow-lg hover:bg-blue-600 transition">Request a bug check</a>
            </div>
        </div>
    </section>
