            ...
            <div class="w-full lg:w-2/3">
                ...
                <div class="w-full mt-12">
                    ...
                    <div class="font-light flex flex-col md:flex-row gap-1 md:gap-16 text-stone-700">
                        ...
                        <ul class="space-y-1">
                            <li><span class="text-blue-600 font-bold mr-2">✓</span>Technical debts</li>
                            <li><span class="text-blue-600 font-bold mr-2">✓</span>Framework upgrades</li>
                            <li><span class="text-blue-600 font-bold mr-2">✓</span>Abandoned libraries & packages</li>
