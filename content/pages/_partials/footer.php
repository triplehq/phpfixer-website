    <footer class="max-w-7xl mx-auto py-4 md:pt-8 md:pb-4 px-6 lg:px-0 lg:pb-12 md:px-4">
        <div class="flex flex-col md:flex-row md:justify-between gap-8 text-stone-700">
            <div class="flex-1">
                ...
                <p class="text-sm/5 max-w-md mt-5 text-zinc-500">Expert PHP troubleshooting, legacy code rescue, and performance tuning for businesses, agencies, and founders. Fast, reliable, and drama-free fixes for most popular frameworks and custom PHP sites.</p>
            </div>
            <div class="flex-1 flex flex-col items-start md:items-end">
                <div class="flex flex-wrap gap-4 md:gap-6 font-bold">
