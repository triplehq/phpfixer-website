            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                <div class="bg-neutral-100 rounded-xl p-6 shadow-sm flex flex-col">
                    ...
                    <ul class="mb-4 space-y-1 text-sm text-neutral-700 flex-1">
                        ...
                        <li>✓ Upgrading deprecated PHP functions to current standards</li>
                    </ul>
                </div>
                <div class="bg-neutral-100 rounded-xl p-6 shadow-sm flex flex-col">
                    ...
                    <ul class="mb-4 space-y-1 text-sm text-neutral-700 flex-1">
                        ...
                        <li>✓ Reducing load times for WordPress and Laravel applications</li>
                    </ul>
                </div>
                <div class="bg-neutral-100 rounded-xl p-6 shadow-sm flex flex-col">
                    ...
                    <ul class="mb-4 space-y-1 text-sm text-neutral-700 flex-1">
                        ...
                        <li>✓ Replacing abandoned packages with supported alternatives</li>
                    </ul>
                </div>
                <div class="bg-neutral-100 rounded-xl p-6 shadow-sm flex flex-col">
                    ...
                    <ul class="mb-4 space-y-1 text-sm text-neutral-700 flex-1">
                        ...
                        <li>✓ Technical debt reduction and code cleanups</li>
                    </ul>
                </div>
                <div class="bg-neutral-100 rounded-xl p-6 shadow-sm flex flex-col">
