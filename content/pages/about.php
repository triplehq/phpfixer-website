        ...
        <div class="max-w-7xl mx-auto flex gap-20">
            <div class="w-2/3">
                ...
                <div class="mb-10">
                    ...
                    <p class="mb-6 text-lg font-light text-neutral-700">If you lose heating, you call a plumber. If the lights go out, you get an electrician. But when a contact form stops working or your homepage shows a server error, there’s no one obvious to call.</p>
                    <p class="mb-6 text-lg font-light text-neutral-700">In many cases, the original developer isn’t around anymore. Or they’ve moved on to bigger work. Maybe there were disagreements, or maybe they just don’t pick up small jobs. You’re left with a problem that no one wants to take on.</p>
